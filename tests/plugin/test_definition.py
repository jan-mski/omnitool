...
@pytest.fixture
def plugin_definition(resource_data_type):
...
def test_plugin_definition(plugin_definition, resource_data_type):
    """
...
def test_plugin_definition_add_resource_operation(plugin_definition):
    """
